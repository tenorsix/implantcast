...
//    echo "upload Successful.<br> " . $_FILES["fileUpload"]["name"] . "<br>" . $new_images;
} else {
//    echo "<br> upload picture fail";
}
$DB->AddNewArticle($_POST['txt1'], $_FILES["fileUpload"]["name"], $_POST['txt2'], $_POST['txt3']);
?>

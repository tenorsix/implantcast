...
$DB = new ConnectDB();
$DB->connect();
$where = "aticle_id = '" . $_GET['ID'] . "'";
$article = $DB->getAllArticle($where);
?>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container span8">
            <h2>Edit Article...</h2>
            <form class="form" method="post" name="form2" id="form2" action="EditArticle_Confirm.php" enctype="multipart/form-data" onsubmit="return chk();">
                <table class="table">
                    <tr>
                        <td class="span3">
                        ...
                        <td>
                            <div class="inline text-left">
                                <input type="text" class="input-large" name="txt1" id="txt1" placeholder="Header" value="<? echo $article[0][1] ?>">
                                <input type="hidden" class="input-large" name="txt0" value="<? echo $article[0][0] ?>">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="inline text-left">
                                <input type="text" class="input-large" name="txt2" id="txt2" placeholder="SubHeader" value="<? echo $article[0][3] ?>">
                            </div>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <td>
                                <div class="inline text-left">
                                    <a href="#" class="thumbnail">
                                        <img src="images/<? echo $article[0][2]; ?>" alt="images/<? echo $article[0][2]; ?>" class="img-rounded">
                                    </a>
                                </div>
                            </td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="inline text-left">
                                <textarea name="txt3" cols="200" rows="10" id="txt3" class="form-control" style="margin: 0px 0px 10px; width: 500px; height: 400px;"><? echo $article[0][4] ?></textarea>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="inline text-center">
                                ...
                                <a href="Article_index.php" class="btn btn-inverse">Back</a>
                            </div>
                        </td>
                    </tr>
    <!--                <tr>

...
<?
	...
	$Uid = $DB->getUid($_SESSION["id"],$_SESSION["pass"]);
	//echo $Uid."<br>";
	$h1_number = "H1_".$Uid;
	//echo $k1_number."<br>";
	$kkk = $DB->searchh1($_SESSION["name"]);
	$numberh1_form = $DB->getnumrow();
	$numberh1 = (int)$numberh1_form + 1;
	$nu = sprintf("%04d", $numberh1);
	$totalh1_number = $h1_number.$nu;
	//echo sprintf("%03d", $numberk1);
	$_SESSION["h1_number"] = $totalh1_number;
...
<?php
	...
	echo "<input type='submit' value='Logout' action='index.html'></div></form>";
	echo "</body></html>";

?>

	<form action="Check_h1.php" method="post" name="form1">
	<center>
...
<br><br><br><img src="images/footerline.jpg" width="100%" height="4" />

  ...
  <div class="container">
        <table class ="table table-hover table-bordered table-condensed">
            ...
            <tr>
                <td>
                    <DIV class="inline">
						...
						$txt16 .= ":".$_POST['txt16v3'];
						?>
                        <h6>Instrument Nurse 1 :  <? echo " ".$_POST['txt16v1'];?></h6>
                        <h6>Instrument Nurse 2 :  <? echo " ".$_POST['txt16v2'];?></h6>
                        <h6>Instrument Nurse 3 :  <? echo " ".$_POST['txt16v3'];?></h6>
						...
						$txt18 .= ":".$_POST['txt18v3'];
						?>
                        <h6>Circulate Nurse 1 :   <? echo " ".$_POST['txt18v1'] ?></h6>
                        <h6>Circulate Nurse 2 :   <? echo " ".$_POST['txt18v2'] ?></h6>
                        <h6>Circulate Nurse 3 :   <? echo " ".$_POST['txt18v3'] ?></h6>
                    </DIV>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <DIV class="inline">
                        <h6>Signature : <?echo $_SESSION["name"]." ".$_SESSION["lastname"];?></h6>
                        <?
            ...
            <tr >
                <td>
                    <DIV class="inline text-center">
                        <a href="k1_confirm.php" class="btn btn-large btn-primary">
                            &nbsp;Confirm&nbsp;</a>
                        <?
                            switch ($_POST["txt6"]){
                                case '1' :
                            ...
                            $linkcancel = "k1_form.php?hn=".$_POST["txt2"]."&hospital=".$_POST["txt3"]."&side=".$side;
                        ?>
...
$_SESSION["k1"][0]  = $_POST["txt1"];
$_SESSION["k1"][1]  = $_POST["txt2"];
$_SESSION["k1"][2]  = $_POST["txt3"];
$_SESSION["k1"][3]  = $_POST["txt4"];
$_SESSION["k1"][4]  = $_POST["txt5"];
$_SESSION["k1"][5]  = $_POST["txt6"];
$_SESSION["k1"][6]  = $_POST["txt7"];
$_SESSION["k1"][7]  = $_POST["txt8"];
$_SESSION["k1"][8]  = $_POST["txt9"];
$_SESSION["k1"][9]  = $_POST["txt10"];
$_SESSION["k1"][10]  = $_POST["txt11"];
$_SESSION["k1"][11]  = $_POST["txt12"];
$_SESSION["k1"][12]  = $_POST["txt13"];
$_SESSION["k1"][13]  = $_POST["txt14"];
$_SESSION["k1"][14]  = $_POST["txt15"];
$_SESSION["k1"][15]  = $txt16;
$_SESSION["k1"][16]  = $_POST["txt17"];
$_SESSION["k1"][17]  = $txt18;
$_SESSION["k1"][18]  = $Tstarted;
$_SESSION["k1"][19]  = $Tfinished;
$_SESSION["k1"][20]  = $_POST["txt21"];
$_SESSION["k1"][21]  = $_POST["txt22"];
$_SESSION["k1"][22]  = $_POST["txt23"];
$_SESSION["k1"][23]  = $_POST["txt24"];
$_SESSION["k1"][24]  = $_POST["txt25"];
$_SESSION["k1"][25]  = $_POST["txt26"];
$_SESSION["k1"][26]  = $_POST["txt27"];
$_SESSION["k1"][27]  = $_POST["txt28"];
$_SESSION["k1"][28]  = $_POST["txt29"];
$_SESSION["k1"][29]  = $_POST["txt30"];
$_SESSION["k1"][30]  = $_POST["txt31"];
$_SESSION["k1"][31]  = $_POST["txt32"];
$_SESSION["k1"][32]  = $_POST["txt33"].$_POST["txt34"].$_POST["txt35"];
$_SESSION["k1"][33]  = $_POST["txt36"].$_POST["txt37"].$_POST["txt38"];
$_SESSION["k1"][34]  = $_POST["txt39"];
$_SESSION["k1"][35]  = $_POST["txt40"]-1;
$_SESSION["k1"][36]  = $_POST["txt41"];
$_SESSION["k1"][37]  = $_POST["txt42"];
$_SESSION["k1"][38]  = $_POST["txt43"];
$_SESSION["k1"][39]  = $_POST["txt44"];
$_SESSION["k1"][40]  = $_POST["txt45"];
$_SESSION["k1"][41]  = $_POST["txt46"];
$_SESSION["k1"][42]  = $_POST["txt47"];
$_SESSION["k1"][43]  = $_POST["txt48"];
$_SESSION["k1"][44]  = $_POST["txt49"];
$_SESSION["k1"][45]  = $_POST["txt50"];
$_SESSION["k1"][46]  = $_POST["txt51"];
$_SESSION["k1"][47]  = $_POST["txt52"];
$_SESSION["k1"][48]  = $_POST["txt53"];
$_SESSION["k1"][49]  = $_POST["txt54"];
$_SESSION["k1"][50]  = $_POST["txt55"];
$_SESSION["k1"][51]  = $_POST["txt56"];
$_SESSION["k1"][52]  = $_POST["txt57"];
$_SESSION["k1"][53]  = $_POST["txt58"];
$_SESSION["k1"][54]  = $_POST["txt59"];
$_SESSION["k1"][55]  = $_POST["txt60"];
$_SESSION["k1"][56]  = $_POST["txt61"];
$_SESSION["k1"][57]  = $_POST["txt62"];
$_SESSION["k1"][58]  = $_POST["txt63"];
$_SESSION["k1"][59]  = $_POST["txt64"];
$_SESSION["k1"][60]  = $_POST["txt65"];
$_SESSION["k1"][61]  = $_POST["txt66"];
$_SESSION["k1"][62]  = $_POST["txt67"];
$_SESSION["k1"][63]  = $_POST["txt68"];
$_SESSION["k1"][64]  = $_POST["txt69"];
$_SESSION["k1"][65]  = $_POST["txt70"];
$_SESSION["k1"][66]  = $_POST["txt71"];
$_SESSION["k1"][67]  = $_POST["txt72"];
$_SESSION["k1"][68]  = $_POST["txt73"];
$_SESSION["k1"][69]  = $_POST["txt74"];
$_SESSION["k1"][70]  = $_POST["txt75"];
$_SESSION["k1"][71]  = $_POST["txt76"];
$_SESSION["k1"][72]  = $_POST["txt77"];
$_SESSION["k1"][73]  = $_POST["txt78"];
$_SESSION["k1"][74]  = $_POST["txt79"];
$_SESSION["k1"][75]  = $_POST["txt80"];
$_SESSION["k1"][76]  = $_POST["txt81"];
$_SESSION["k1"][77]  = $_POST["txt82"];

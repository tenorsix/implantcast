...
<form action="womac_check.php" method="post" name="form1">
<div class="container">
    <div class="container">
		<table class ="table table-hover table-bordered">
				...
				<tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan ='3'>
                                        <DIV class="inline">
                                            <input class="input-medium" type="text" name="text1h" value="<?echo $_SESSION["womac_number"];?>" disabled="disabled">
                                ...
                                <tr>
                                    ...
                                    <td colspan ='3'>
                                        <DIV class="inline">
                                            ...
                                            <input class="input-medium" type="text" name="txt3h" value="<?echo $_GET['name']?>" disabled="disabled">
                                            <input class="input-medium" type="hidden" name="txt3" value="<?echo $_GET['name']?>">
                                        </DIV>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan ='3'>
                                        <DIV class="inline">
                                            ...
                                            <input class="input-medium" type="text" name="txt4h" value="<?echo $_GET['hn']?>" disabled="disabled">
                                            <input class="input-medium" type="hidden" name="txt4" value="<?echo $_GET['hn']?>">
                                        </DIV>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan ='3'>
                                        <DIV class="inline">
                                            ...
                                            <input class="input-medium" type="text" name="txt5h" value="<?echo $_GET['age']?>" disabled="disabled">
                                            <input class="input-medium" type="hidden" name="txt5" value="<?echo $_GET['age']?>">
                                        </DIV>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan ='3'>
                                        <DIV class="inline">
                                            <h5>
                                                <input class="input-medium" type="text" name="txt6h" value="<?echo $_GET['sex']?>" disabled="disabled">
                                                <input class="input-medium" type="hidden" name="txt6" value="<?echo $_GET['sex']?>">
                                                <!--
                                              <label class="radio">
                                ...
                                <tr>
                                    ...
                                    <td colspan ='3'>
                                        <DIV class="inline">
                                            <input class="input-medium" type="text" name="txt7" OnChange="JavaScript:fncCalBMI();" OnClick="JavaScript:fncChecktxt1();" value="<?echo $_GET['weight'];?>" onload="JavaScript:fncCalBMI();">
                                        </DIV>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan ='3'>
                                        <DIV class="inline">
                                            <input class="input-medium" type="text" name="txt8" OnChange="JavaScript:fncCalBMI();" OnClick="JavaScript:fncChecktxt2();"value="<?echo $_GET['height'];?>" onload="JavaScript:fncCalBMI();">
                                        </DIV>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan ='3'>
                                        <DIV class="inline">
                                            <input class="input-medium" type="hidden" name="txt9" value="<?echo $_GET['bmi'];?>">
                                            <input class="input-medium" type="text" name="txt9h" value="<?echo $_GET['bmi'];?>" disabled="disabled"> *( Weight / Height^2 )
                                        </DIV>
                                    </td>
                                </tr>
                                <tr>
...
<!--                                    <td colspan ='3'>
                                        <DIV class="inline">
                                            <input class="input-medium" type="text" name="txt12h" value="Pre Op." disabled="disabled">
                                            <input class="input-medium" type="hidden" name="txt12" value="0">
                                        </DIV>
                                    </td>-->
                                    <td colspan ='3'>
                                        <DIV class="inline">
